...
interface OrderDetails {
    ...
    loyaltyCoffeeCount?: number;
    loyaltyRewardEarned?: boolean;
    isPaid?: boolean;
    isRefund?: boolean;
    refundAmount?: number;
    isEdit?: boolean;
...
const OrderConfirmationModal = ({ isOpen, orderDetails, onStartNewOrder }: OrderConfirmationModalProps) => {
    useEffect(() => {
        if (!isOpen) return;
    ...
    const hasDiscounts = (soldierDiscountAmount ?? 0) > 0 || (loyaltyDiscount ?? 0) > 0;
                    ...
                    <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3">
                        ...
                        {hasDiscounts && subtotal && (
                            <div className="space-y-1 text-sm border-b border-slate-200 pb-3">
                                ...
                                {soldierDiscountAmount && soldierDiscountAmount > 0 && (
